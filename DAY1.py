...
name = "김철수"
print(name)
## 문자열은 작은따옴표(' ') 또는 큰따옴표(" ")를 이용하여 표현한다.
...
a = D * 0.00072
print(a)
## 변수 이름을 won, dollar처럼 의미가 드러나게 지으면 코드를 읽기 쉬워진다.
## 환율은 매일 바뀌므로 0.00072는 예시 값이다.


# 자기소개 카드
print("자기소개 카드를 만들어 드립니다.")

name = input("이름을 입력하세요: ")
age = int(input("나이를 입력하세요: "))
hobby = input("취미를 공백으로 구분해서 입력하세요: ")
...
print("나이:", age, "세")
print("내년 나이:", age + 1, "세")
print("이름 글자 수:", len(name))
print("취미 개수:", len(hobby_list))
print("취미 목록:", hobby_list)
print("=" * 20)
## input()으로 입력받은 값은 모두 문자열이므로 계산에 쓰려면 int()로 변환해야 한다.
## split()을 이용하여 공백을 기준으로 여러 개의 취미를 나눌 수 있다.
## len()은 문자열의 글자 수와 나눠진 값의 개수를 모두 셀 수 있다.
## "=" * 20은 문자열을 20번 반복하여 출력한다.
...
print ('인당 내야할 가격:' , q)
print ('남는 돈:' , w)
## divmod()를 이용하여 피자 조각 수와 가격을 계산할 수 있다.
